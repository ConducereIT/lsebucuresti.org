...
import Furtuna from "../assets/img/Portraits/coordonatori/portrait_teodor_furtuna.jpg";
export default function Membrii({ title, members, grid }) {
  const content = `grid lg:grid-cols-${grid} md:grid-cols-3 grid-cols-2 md:gap-10`;
  return (
    <>
      <div className="m-auto mx-2 md:pb-5 py-10">
        ...
        <div className={content}>
          {members.map((member, index) => (
            ...
            >
              <img className="w-full" src={member.image} alt="Poza membru" />
