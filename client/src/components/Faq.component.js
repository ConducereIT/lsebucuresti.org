...
const FAQ = () => {
  ...
  const toggle2 = (i2) => {
    if (selected2 === i2) return setSelected2(null);
    setSelected2(i2);
  };

  return (
    <div className="flex flex-col h-full justify-center items-center">
      <div className="tracking-wider text-xs font-[600]">
        AI NEVOIE DE AJUTOR?
      </div>
      <div className="tracking-wider font-[700] text-[1.2cm]">FAQs</div>
      <div className="tracking-wider font-[600] text-[0.4cm]">
        Sperăm să te ajutăm cu câteva răspunsuri la cele mai adresate întrebări
        legate de LSE și ETTI.
      </div>
          ...
          {data1.map((item, i) => (
            <div className="flex flex-col m-2 bg-gray-400 w-[70%] ">
              ...
              <div
                className={
                  selected === i
                    ? "h-auto max-h-56 transition-all"
